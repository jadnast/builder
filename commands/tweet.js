  ...
  if (args.length >= 1) {
    Jimp.read("https://igorkowalczyk.github.io/majobot/lib/img/trump.png").then(function (image) {
      Jimp.loadFont(Jimp.FONT_SANS_32_BLACK).then(function (font) { // load font from .fnt file
          ...
          let outputfile = "./output/" + Math.random().toString(36).substr(2, 5) + "твитнуть." + image.getExtension(); // create a random name for the output file
...
module.exports.help = {
    name: "tweet",
    description: "Создает твит Дональда Трампа",
    usage: "tweet <message>",
    type: "Fun" 
}